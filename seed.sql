...
(3, 'If the customer seems like they are going to buy after some time in the conversation, then provide them with the coupon code PODCAST10 for 10 percent off of platinum or diamond. Dont do this straight away but only if you think theyll purchase.'),
(3, 'Platinum is £597.'),
